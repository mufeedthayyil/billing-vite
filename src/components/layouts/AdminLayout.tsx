...
import { Camera, LayoutDashboard, Users, CreditCard, Settings, LogOut, Menu, X } from 'lucide-react';
...
const AdminLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { icon: <Camera size={20} />, label: 'Equipment', path: '/admin/equipment' },
    { icon: <CreditCard size={20} />, label: 'Billing', path: '/admin/billing' },
    { icon: <Users size={20} />, label: 'Clients', path: '/admin/clients' },
    { icon: <Settings size={20} />, label: 'Profile', path: '/admin/profile' },
  ];
